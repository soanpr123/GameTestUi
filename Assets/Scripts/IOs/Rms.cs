...
public class Rms
{
    ...
    private static void __saveRMS(string filename, sbyte[] data)
    {
        ...
        fileStream.Write(PlayerUtil.convertToByteArray(data), 0, data.Length);
        fileStream.Flush();
        fileStream.Close();
    ...
    private static sbyte[] __loadRMS(string filename)
    {
        try
        {
            ...
            fileStream.Close();
            sbyte[] array2 = PlayerUtil.convertToSbyteArray(array);
            return PlayerUtil.convertToSbyteArray(array);
        }
        catch (Exception)
        {
            return null;
    ...
    public static void deleteRecord(string name)
    {
        ...
        {
            Debug.LogError("loi xoa RMS --------------------------" + ex.ToString());
        }
    }
